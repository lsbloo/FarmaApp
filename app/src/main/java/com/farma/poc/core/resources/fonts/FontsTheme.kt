...
interface PropertiesFont {
    fun setupStyle(shadow: Shadow, fontFamily: FontFamily): TextStyle
}
...
enum class FontEnum(val textStyle: TextStyle): PropertiesFont {
    H1(
        ...
        override fun setupStyle(shadow: Shadow, fontFamily: FontFamily): TextStyle {
            return TextStyle(
...
class FontsTheme(shadow: Shadow) {
